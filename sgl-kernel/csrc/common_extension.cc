...
TORCH_LIBRARY_FRAGMENT(sgl_kernel, m) {
  ...
  m.def(
      ...
      "num_warps_per_block) -> ()");
  m.impl("transfer_kv_per_layer_pfd_lf", torch::kCUDA, &transfer_kv_per_layer_pfd_lf);
  m.def(
  ...
  m.impl("transfer_kv_per_layer_mla_pfd_lf", torch::kCUDA, &transfer_kv_per_layer_mla_pfd_lf);
  m.def(
